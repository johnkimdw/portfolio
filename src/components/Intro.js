    ...
    return (
        ...
        <div class="w-screen h-screen max-w-full max-h-3xl pt-16">
            <div class="container mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
                <div class="bg-primary/30 px-20 py-20 mx-22 my-20 relative block overflow-hidden rounded-lg p-4 sm:p-6 lg:p-8">
                    ...
                    <div class="grid grid-cols-2 sm:justify-between sm:gap-4">
                        ...
                        <div>
                            ...
                            <br/>
                            <p className="mt-1 text-xl font-medium text-gray-700">I am a sophomore at the University of Notre Dame and a developer who strives to bridge the gap between complex technologies and human beings.</p>
                            <br/>
                            <p class="mt-1 text-xl font-medium text-text">Incoming SWE intern @ Humana</p>
                            
                            <br/>
                            <p className="mt-1 text-xl font-medium text-gray-700">Currently a research assistant at the Lucy Institute of Data and Society</p>
                        </div>
                        {/* COL 2 */}
