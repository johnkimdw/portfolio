...
It's not a bad thing, since the earlier you choose your path, the farther you will be compared to others. But as I look back, I feel that I haven't stuck to a path. I have been a generalist most of my life. I didn't take my first programming class until I entered college, I had no particular passion in high school and chose biochemistry/chemical engineering because I was good at it, and I just enjoyed learning stuff. I feel strange considering I just turned 21, and it seemed only yesterday when I had to make the same decision on what major I would choose. 
...
That summer was when I decided to switch my major from chemical engineering to computer science. Soon after, I emailed a program director at the [Lucy Family Institute for Data and Society](https://lucyinstitute.nd.edu/) (at Notre Dame), where I then connected with [Professor Nuno Moniz](https://www.nunomoniz.co/). To be honest, as a freshman I didn't know what I wanted to research specifically, just broadly things that help people. Now, as a research assistant, I worked on several projects, including grid search and imbalanced data in cancer classification tasks. However, my first real project involved providing algorithmic recourses in regression settings, where most previous work had focused purely on classification. I think the reason for this is that it is easier to minimize a cost function with some decision boundary to cross, but regression tasks are more difficult with how the range is continuous. It was important because our work can be extended to high-stakes decision making domains like healthcare, loan denials, and criminal justice to provide marginalized communities explanations and steps to overturn decisions.
